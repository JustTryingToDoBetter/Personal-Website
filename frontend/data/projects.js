export const projects = [
  {
    ...
    category: 'Systems',
    tech: ['Python', 'PostgreSQL', 'Docker', 'Benchmarking'],
    impact: 'Sustained deterministic throughput under synthetic load with reproducible profiling traces.',
    href: 'https://github.com/JustTryingToDoBetter/order-matching-engine',
    description: 'order-matching engine and benchmark harness focused on deterministic throughput measurement and profiling',
    image:
  ...
  },
  {
    ...
    title: 'Distributed Video Processing Platform',
    category: 'Systems',
  ...
  },
  {
    ...
    category: 'AI',
    tech: ['Python', 'ETL', 'Data Pipeline', 'Analytics'],
    impact: 'Standardized batch ingestion and analysis to improve reliability of recurring trend reports.',
    href: 'https://github.com/JustTryingToDoBetter/youtube-trending-video-analysis',
    description: 'This project implements a production-style batch ETL pipeline to analyze YouTube trending videos.',
    image:
      'https://images.unsplash.com/photo-1523961131990-5ea7c61b2107?q=80&w=1074&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
  {
    id: 'mobile-app',
    title: 'Cipher Engine',
